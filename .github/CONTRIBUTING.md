...
to run a dependency analysis, automatically refactor code, enforce coding standards, run a security analysis, run a static code analysis, run tests, and run mutation tests!
